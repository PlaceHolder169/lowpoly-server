...
const VALID_PRIMARY = ['AK-47', 'M4A1', '沙鹰', 'AWM', '毛瑟', 'P90', 'S686', 'M200', 'Kar98k', '左轮', 'M14'];
const VALID_MELEE = ['匕首', '蝴蝶刀', '尼泊尔', '爪刀', '武士刀'];
...
const MELEE_DAMAGE: Record<string, number> = { '匕首': 35, '蝴蝶刀': 55, '尼泊尔': 80, '爪刀': 45, '武士刀': 90 };
const GUN_BODY_DAMAGE: Record<string, number> = {
  'AK-47': 33, 'M4A1': 28, '沙鹰': 63, 'AWM': 115,
...
export class GameRoom extends Room<GameState> {
  ...
  onCreate(options: any) {
    ...
    console.error(`🎮 新房间已创建 (maxClients=${this.maxClients})`);
